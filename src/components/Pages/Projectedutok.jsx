// src/pages/ProjectEdutok.jsx

import { useNavigate } from 'react-router-dom';
import ParticlesBg from '../ParticlesBg';

export default function ProjectEdutok() {
    ...
    <div style={s.page}>
      ...
      <div style={s.inner}>
        ...
        <div style={s.header}>
          ...
          <h1 style={s.title}>EduTok</h1>
          <p style={s.sub}>Plataforma de vídeo educativo al estilo TikTok. Aprender sin perder el ritmo.</p>
        </div>

        <div style={s.layout}>
          <div>
            <p style={s.body}>
              EduTok nació de una pregunta: ¿por qué el contenido educativo online sigue siendo
              tan aburrido de consumir si ya sabemos que el formato de vídeo corto engancha?
              El reto era diseñar una plataforma que aprovechara la mecánica del scroll infinito
              de TikTok pero orientada al aprendizaje.
            </p>
            <p style={s.body}>
              El diseño se centró en tres flujos principales: onboarding con selección de intereses,
              feed de vídeos educativos con interacciones rápidas, y perfil con seguimiento de progreso.
              Todo pensado para que el usuario no saliera de la app con la sensación de haber
              perdido el tiempo.
            </p>
            ...
            <div style={s.metaBlock}>
              ...
              <div style={s.metaItem}>
                ...
                <span style={s.metaVal}>Diseño UX/UI · App móvil</span>
              </div>
              <div style={s.metaItem}>
            ...
            <a
              href="https://www.figma.com/proto/IYZNU4lF25iy3ypMXUKSzi/Proyecto-UX-UI?node-id=191-436"
              target="_blank"
              rel="noreferrer"
              style={s.btnPrimary}
            >
          ...
          <div style={s.embedWrap}>
            ...
            <iframe
              style={s.embed}
              src="https://www.figma.com/embed?embed_host=share&url=https://www.figma.com/proto/IYZNU4lF25iy3ypMXUKSzi/Proyecto-UX-UI?node-id=191-436%26scaling=scale-down%26hide-ui=1"
              title="EduTok Figma"
            />
          </div>
        </div>
...
const s = {
  ...
  embed:      { width: '100%', height: 480, border: '1px solid var(--border)', borderRadius: 12, background: 'var(--bg2)' },
};